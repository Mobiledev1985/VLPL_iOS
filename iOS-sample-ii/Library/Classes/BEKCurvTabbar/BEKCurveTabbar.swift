...
public class BEKCurveTabbar: UITabBar {
     ...
     */
    @IBInspectable public var borderColor1: UIColor = .clear  {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    /**
     ...
     - Default is 1.0.
     */
    @IBInspectable public var borderWidth1: CGFloat = 1.0  {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    /**
     ...
     - Default is black.
     */
    @IBInspectable public var shadowColor1: UIColor = UIColor(white: 0, alpha: 0.2)  {
        didSet {
            layoutIfNeeded()
        }
    }
    /**
     ...
     - Default is 30.0.
     */
    @IBInspectable public var shadowRadius1: CGFloat = 30.0  {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    private func addBackgroundShape() {
        ...
        shapeLayer.lineWidth = borderWidth1
        shapeLayer.shadowColor = shadowColor1.cgColor
        shapeLayer.shadowRadius = shadowRadius1
    ...
    public func setup(viewModel: BEKTabBarViewModelType){
        ...
        borderColor1 = viewModel.containerBorderColor
        borderWidth1 = viewModel.containerBorderWidth
        labelOffset = viewModel.textOffset
        shadowRadius1 = viewModel.shadowRadius
        shadowColor1 = viewModel.shadowColor
